  ...
  test('should get pair contract', async () => {
    const { anc } = await wasmFetch<AncWasmQuery>({
      ...
      wasmQuery: {
        anc: {
          contractAddress:
            'furya18qpjm4zkvqnpjpw0zn0tdr8gdzvt8au35v45xf' as HumanAddr,
          query: {
            pair: {
              asset_infos: [
                {
                ...
                },
                {
                  token: {
                    contract_addr:
                      'furya1747mad58h0w4y589y3sk84r5efqdev9q4r02pc' as CW20Addr,
                  },
                },
              ],
            },
    ...
    expect(anc.contract_addr).toBe(
      'furya1wfvczps2865j0awnurk9m04u7wdmd6qv3fdnvz',
    );
  });
});
